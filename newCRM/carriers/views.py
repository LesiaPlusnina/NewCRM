...
from carriers.models import Customer
...
class CustomerCreateView(OrganisorAndLoginRequiredMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            subject="You are invited to be an customer",
            message="You were added as an agent on newCRM. Please come login to start working.",
